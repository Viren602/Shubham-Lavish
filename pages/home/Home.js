            ...
            <div className="container">
              <div className="inner flex flex-col md:flex-row items-center gap-10 mt-6">
                ...
                <div className="w-full md:w-1/2">
                  <img src="banner.png" alt="Banner" className="w-full h-auto rounded-md" />
                </div>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="mt-6">
                  <ul className="flex flex-wrap justify-center items-center gap-6 md:gap-10">
                    <li><img src="Logo-1.png" className="h-6 sm:h-8 md:h-10" /></li>
                    <li><img src="Logo-2.png"  className="h-6 sm:h-8 md:h-10" /></li>
                    <li><img src="Logo-3.png"  className="h-6 sm:h-8 md:h-10" /></li>
                    <li><img src="Logo-4.png"  className="h-6 sm:h-8 md:h-10" /></li>
                    <li><img src="Logo-5.png"  className="h-6 sm:h-8 md:h-10" /></li>
                    <li> <img src="Logo-6.png"  className="h-6 sm:h-8 md:h-10" /></li>
                  </ul>
                </div>
              </div>
            </div>
                ...
                <div className="relative flex gap-6">
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute my-[20px] lg:mx-[-40px] mx-[-20px]">
                      <img src="frame-info.png" className="w-[800px] rounded-lg lg:mx-[-30px] sm:mx-[-40px] mx-[-14px] my-[-10px]"/>
                    </div>
                  </div>
                </div>
              ...
              <div className="services-inner mt-[90px] flex-col md:flex-row items-center gap-10 mt-6">
                ...
                <div className="mt-[20px]">
                  <ul className="flex lg:flex-row gap-4 flex-col">
                    <li>
                      <img src="interior design.png" className="w-full sm:w-auto rounded-lg" />
                    </li>
                    <li>
                      {" "}
                      <img src="Architecture.png" className="w-full sm:w-auto rounded-lg"/>
                    </li>
                    <li>
                      <img src="Furniture Design.png" className="w-full sm:w-auto rounded-lg"/>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="latest-project">
            <div className="container">
              <div className="latest-project-inner mt-[90px]">
                <h6 className="text-xl sm:text-2xl md:text-3xl lg:text-xl font-bold">Our Project</h6>
                <h3 className="mt-[10px] sm:text-2xl md:text-3xl lg:text-4xl font-bold">Our Latest Projects</h3>
          ...
          <div className="blog">
            <div className="container">
              <div className="blog-inner mt-[90px] my-[80px]">
                <h6>Our Blog</h6>
                <h3 className="mt-2 text-2xl lg:text-5xl font-bold">Latest News and Articles</h3>
                <div className="md:flex gap-[40px]">
                  <div className="my-[50px]">
                    <img src="Design1.png" />
                    <h6 className="mt-[8px]">interior Design</h6>
                    <h3 className="text-2xl lg:text-5xl">Designer must be an interpreter</h3>
                    <p className="mt-[25px]">
                  ...
                  <div className="my-[50px]">
                    <img src="Design2.png" />
                    <h6 className="mt-[8px]">interior Design</h6>
                    <h3 className="text-2xl lg:text-5xl">12 Best Outdoor Furniture Ideas</h3>
                    <p className="mt-[25px]">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Adipiscing dui tellus commodo convallis. Auctor eget orci
                      pharetra non.
                  ...
                  <div className="my-[50px]">
                    <img src="Design3.png" />
                    <h6 className="mt-[8px]">interior Design</h6>
                    <h3 className="text-2xl lg:text-5xl">10 Of The Unique Buildings</h3>
                    <p className="mt-[25px]">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Adipiscing dui tellus commodo convallis. Auctor eget orci
                      pharetra non.
