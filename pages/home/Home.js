      ...
      <>
        ...
        <div className="container">
          <div className="inner mt-[40px] flex items-center gap-[90px]">
            ...
            <div className="">
              <ul className="flex w-[900px] gap-[35px]">
                <li>
                  <img src="Logo-1.png" />
                </li>
                <li>
        ...
        <div className="container">
          <div className="inner">
            <div className="flex mt-[60px] gap-[50px]">
              <div className="static flex gap-[25px]">
                <div>
                  <img src="frame-image.png" />
                </div>
                <div>
                  <img src="hall-image.png" />
                  <div className="absolute top-[960px] right-[445px] left-[0px] w-[350px] mx-auto">
                    <img src="frame-info.png" className="mr-[200px]" />
                  </div>
                </div>
              </div>
              ``
              <div className="w-[680px] mt-[40px]">
                <h6 className="fs-[18px]">---- Hello There</h6>
            ...
            <h3 className="mt-[10px]">Latest News and Articles</h3>
              <div className="mt-[20px] flex gap-[40px]">
                <div>
                  ...
                  <h3>Designer must be an interpreter</h3>
                  <p className="mt-[25px]">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Adipiscing dui tellus commodo convallis. Auctor eget orci
                    pharetra non.
                ...
                <div>
                  <img src="Design2.png" />
                  <h6 className="mt-[8px]">interior Design</h6>
                  <h3>12 Best Outdoor Furniture Ideas</h3>
                  <p className="mt-[25px]">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Adipiscing dui tellus commodo convallis. Auctor eget orci
                    pharetra non.
                ...
                <div>
                  <img src="Design3.png" />
                  <h6 className="mt-[8px]">interior Design</h6>
                  <h3>10 Of The Unique Buildings</h3>
                  <p className="mt-[25px]">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Adipiscing dui tellus commodo convallis. Auctor eget orci
                    pharetra non.
